...
// UI
#define UI_DEFAULT_COLOR (SDL_Color){ 255, 255, 255, 255 }
#define UI_DEFAULT_BACKGROUND_COLOR (SDL_Color){ 0, 0, 0, 0 }
#define UI_INFOLABEL_WIDTH 2.0f
#define UI_INFOLABEL_HEIGHT 1.0f
#define UI_INFOLABEL_BACKGROUND_COLOR (SDL_Color){ 150, 150, 150, 150 }
#define UI_INFOLABEL_FONT_COLOR (SDL_Color){ 255, 255, 255, 255 }
#define UI_INFOLABEL_FONT_SIZE (WINDOW_SCALE * 0.8f)
#define UI_MENU_BUTTON_TEXT "Continue"
#define UI_MENU_BUTTON_POS \
	(SDL_FPoint){ WINDOW_WIDTH_SCALE / 2.0f, WINDOW_HEIGHT_SCALE / 2.0f }
#define UI_START_TITLE_TEXT WINDOW_NAME
