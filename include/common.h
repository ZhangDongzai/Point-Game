...
#define UI_MENU_BUTTON_POS \
	(SDL_FPoint){ WINDOW_WIDTH_SCALE / 2, WINDOW_HEIGHT_SCALE / 2 }
#define UI_START_TITLE_TEXT WINDOW_NAME
#define UI_START_TITLE_POS (SDL_FPoint){ WINDOW_WIDTH_SCALE / 2, 2 }
#define UI_START_BUTTON_TEXT "Start"
#define UI_START_BUTTON_POS (SDL_FPoint){ WINDOW_WIDTH_SCALE / 2, 6 }
